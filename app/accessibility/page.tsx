...
export const metadata: Metadata = {
    ...
    description: 'Tile Club is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Tile Club accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Tile Club accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Tile Club is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Tile Club presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Tile Club. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@tileclub.site</strong></li>
                </ul>
                <p>
