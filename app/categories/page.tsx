...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Tile Club puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Tile Club categories'],
  alternates: {
