...
const SUPPORT_EMAIL = 'hello@tileclub.site';

export const metadata: Metadata = {
    title: 'Contact Tile Club',
    description: 'Get in touch with the Tile Club team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Tile Club', 'Tile Club support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
