...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Tile Club uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Tile Club cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Tile Club uses them, and how you can
                ...
                <p>Tile Club uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Tile Club.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@tileclub.site</strong>.
                </p>
            </div>
        </>
    );
