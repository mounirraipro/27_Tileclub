...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Tile Club disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Tile Club disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Tile Club (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on tileclub.site
                ...
                <p>
                    Tile Club is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Tile Club displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Tile Club.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Tile Club is not responsible for any errors
