...
const SITE_URL = 'https://tileclub.site';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Tile Club',
        url: SITE_URL,
        description: 'Play Tile Club free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Tile Club online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
