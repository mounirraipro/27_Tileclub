...
export const metadata: Metadata = {
    ...
    description: 'Tile Club is a safe, educational, and family-friendly game. Learn how we protect children and promote healthy screen time.',
    keywords: ['Tile Club for kids', 'safe game', 'children online safety', 'educational game', 'family friendly games'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Everything parents need to know about Tile Club and online safety.</p>
                </div>
            </div>
            ...
            <div className="page-content">
                ...
                <p>
                    Tile Club is a family-friendly game created to provide wholesome entertainment
                    for players of all ages. We understand that parents care deeply about what their children
                    do online, and we&apos;ve built Tile Club with safety, education, and fun as our core priorities.
                </p>
                ...
                <p>
                    ...
                    children and adults alike. Here&apos;s what your child gains from playing Tile Club:
                </p>
                <ul>
                ...
                <p>
                    Tile Club does not collect any personal information from children. There are no
                ...
                <p>
                    Tile Club is completely free to play with no hidden costs. There are no virtual
                ...
                <p>
                    All content used in Tile Club is carefully curated to be appropriate for all ages.
                    All content in Tile Club is carefully selected to be appropriate for all ages.
                </p>

                <h3>Advertisements</h3>
                <p>
                    Tile Club displays advertisements to support the free service. These ads are served
                ...
                <p>
                    We take the Children&apos;s Online Privacy Protection Act (COPPA) seriously. Tile Club
                ...
                <p>
                    While Tile Club is designed to be safe, we encourage parents to take an active role
                ...
                <ol>
                    ...
                    <li><strong>Discuss online safety:</strong> Use Tile Club as a starting point to talk about safe internet habits.</li>
                ...
                <h2>Have Concerns?</h2>
                <p>
                    If you have any questions or concerns about your child&apos;s experience on Tile Club,
