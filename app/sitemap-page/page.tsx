...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Tile Club. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Tile Club sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Tile Club' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Tile Club?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Tile Club.</p>
                </div>
            </div>
