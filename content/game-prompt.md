...
## GENRE CONTEXT - MATCH-3

Use this knowledge to write accurate, specific content. Do NOT treat this as a generic game.

- **Core mechanics:** swap adjacent tiles/blocks to match 3+ of the same type; chain combos for bonus points
- **Target audience:** casual players, all ages, especially popular with 25-55 age group
- **Key player benefits:** relaxing, satisfying combo chains, quick session lengths
- **Playstyle:** casual and fast; satisfying visual feedback from combos
- **Level structure:** goal-based levels (collect X, clear Y tiles); star ratings per level
- **SEO angles to use:** free match-3 game, tile matching game online, browser candy game
- **Tip writing style:** look for combo opportunities, work from the bottom, target level objectives first
...
- Name five real difficulty tiers or game-mode categories that fit Match-3 games.
...

{
  ...
  "homepage": {
    ...
    "faq": [
      { "q": "What is Tile Club?",             "a": "..." },
      { "q": "Is Tile Club free?",             "a": "..." },
      { "q": "Does Tile Club work on mobile?", "a": "..." },
      { "q": "How many levels are there?",  "a": "..." },
      { "q": "Is Tile Club safe for kids?",    "a": "..." },
    ...
    "posts": [
      {
        ...
        "title": "Getting Started with Tile Club: A Complete Beginner's Guide",
        "excerpt": "...",
        "category": "Guide",
        "readTime": "5 min read",
        "date": "2026-01-01",
        "icon": "🗺️",
        "sections": [
          { "heading": "What Is Tile Club?",    "paragraphs": ["...", "..."] },
      ...
      },
      {
        ...
        "title": "Top Tips & Tricks for Tile Club",
        "excerpt": "...",
        "category": "Strategy",
        "readTime": "7 min read",
        "date": "2026-01-05",
      ...
      {
        "slug": "game-benefits",
        "title": "The Cognitive Benefits of Playing Tile Club",
        "excerpt": "...",
        "category": "Science",
        "readTime": "6 min read",
        "date": "2026-01-10",
      ...
      {
        "slug": "how-to-improve",
        "title": "How to Get Better at Tile Club",
        "excerpt": "...",
        "category": "Strategy",
        "readTime": "8 min read",
        "date": "2026-01-15",
      ...
      {
        "slug": "parents-guide",
        "title": "Tile Club for Kids: A Parent's Complete Guide",
        "excerpt": "...",
        "category": "Family",
        "readTime": "6 min read",
        "date": "2026-01-20",
        "icon": "👨‍👩‍👧",
        "sections": [
          { "heading": "Is Tile Club Safe for Children?", "paragraphs": ["...", "..."] },
